CREATE TABLE
    IF
    NOT EXISTS hsom_flyway.auth_pass_record_bak
SELECT *
...
INSERT INTO `flyway_test`.`auth_pass_record`(`ID`, `DEVICE_ID`, `ROOM_CODE`, `PERSON_ID`, `FULL_NAME`, `CARD_NUMBER`,
                                             ...
                                             `UPDATE_TIME`, `REMARK`,
                                             `PERSON_ATTRIBUTE`)
VALUES (1456306972508401662, '4810081e28a34becb652a219f47c8cad', 'B7-2121', '', NULL, NULL, '1463076768405934081', '3',
...
INSERT INTO `flyway_test`.`auth_pass_record`(`ID`, `DEVICE_ID`, `ROOM_CODE`, `PERSON_ID`, `FULL_NAME`, `CARD_NUMBER`,
                                             ...
                                             `UPDATE_TIME`, `REMARK`,
                                             `PERSON_ATTRIBUTE`)
VALUES (14563401665, '4810081e28a34becb652a219f47c8cad', 'B7-2121', '', NULL, NULL, '1463076768405934081', '3',
        '2021-11-05 01:08:13', '0', '0',
        '2021-11-05 01:08:13', '2021-11-05 01:06:54', NULL, NULL);
