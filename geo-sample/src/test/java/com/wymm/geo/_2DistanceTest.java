...
public class _2DistanceTest {
    ...
    void geoContains() {
        ...
        boolean isInside = GeoUtils.isPointInGeoJSON(geojsonText, longitude, latitude);
        if (isInside) {
    ...
    void convert(){
        ...
        boolean inArea = GeoUtils.isPointInGeoJSON(geojsonText, 113.2866641658, 22.8992521491);
