...
import com.wymm.easyexcelsample.excel.fill.FillData;
...
public class _7FillTest {
    ...
    public void simpleFill() {
        ...
        String templateFileName =
                TestFileUtil.getPath() + "fill" + File.separator + "simple.xlsx";
    ...
    public void listFill() {
        ...
        String templateFileName =
                TestFileUtil.getPath() + "fill" + File.separator + "list.xlsx";
    ...
    public void horizontalFill() {
        String templateFileName =
                TestFileUtil.getPath() + "fill" + File.separator + "horizontal.xlsx";
    ...
    public void compositeFill() {
        ...
        // {} 代表普通变量 {.} 代表是list的变量 {前缀.} 前缀可以区分不同的list
        String templateFileName =
                TestFileUtil.getPath() + "fill" + File.separator + "composite.xlsx";
